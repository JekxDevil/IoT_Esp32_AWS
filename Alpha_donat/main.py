...
# external devices
import device_supports.bme280 as bme280
# include ws2812b led strip (useless)
from device_supports.ws2812 import WS2812
...
def format_timetuple_and_zone(timetuple, zone):
    return "%s, %02d %s %04d %02d:%02d:%02d %s" % (
        ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"] [timetuple[6]], timetuple[2],
        ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec",]
        [timetuple[1] - 1], timetuple[0], timetuple[3], timetuple[4], timetuple[5],zone, )
...
#from ftp import ftpserver
    ...
    devices = [
        ...
        {
            "description": "orange led",#nomi dei sensori
            "port": 12344,
    ...
    # setting the clock using ntp Wemos ESP-WROOM-32
